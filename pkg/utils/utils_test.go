...
func TestInputToBNB48Inscription1(t *testing.T) {
	input := ""
	inss, err := InputToBNB48Inscription(input, 48_484_848)
	assert.NoError(t, err)
	assert.Equal(t, len(inss), 1)
	rs := inss[0]
	assert.Equal(t, rs.P, "bnb-48")
	assert.Equal(t, rs.Op, "approve")
}
